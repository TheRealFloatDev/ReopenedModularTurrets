...
public class PotatoCannonTurretModel extends PartModel implements AnimatedTurretModel {
    ...
    public PotatoCannonTurretModel(ModelPart root) {
        super(root);
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        rootDef.addOrReplaceChild(
                "barrel",
                CubeListBuilder.create().texOffs(36, 0).addBox(-1F, -2F, -11F, 2F, 3F, 12F),
                PartPose.offset(0F, 15F, 0F));
        rootDef.addOrReplaceChild(
                "chamber",
                CubeListBuilder.create().texOffs(0, 4).addBox(-2F, -3F, 1F, 4F, 4F, 4F),
                PartPose.offset(0F, 15F, 0F));
    ...
    public void setupAnim(DirectedTurretModelState state) {
        ...
        for (ModelPart part : new ModelPart[] { barrel, chamber }) {
            part.xRot = rotationX;
            part.yRot = rotationZ;
        }
    }
