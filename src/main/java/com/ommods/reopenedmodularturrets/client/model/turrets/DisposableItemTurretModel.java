...
public class DisposableItemTurretModel extends PartModel implements AnimatedTurretModel {
    ...
    public DisposableItemTurretModel(ModelPart root) {
        super(root);
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        rootDef.addOrReplaceChild(
                "box_under",
                CubeListBuilder.create().texOffs(0, 19).addBox(-4F, 3F, -4F, 8F, 1F, 8F),
                PartPose.offset(0F, 16F, 0F));
        rootDef.addOrReplaceChild(
                "box_left",
                CubeListBuilder.create().texOffs(0, 19).addBox(-4F, 4F, -4F, 8F, 1F, 8F),
                PartPose.offsetAndRotation(0F, 16F, 0F, 0F, 0F, 1.570796F));
        rootDef.addOrReplaceChild(
                "box_right",
                CubeListBuilder.create().texOffs(0, 19).addBox(-4F, -5F, -4F, 8F, 1F, 8F),
                PartPose.offsetAndRotation(0F, 16F, 0F, 0F, 0F, 1.570796F));
        rootDef.addOrReplaceChild(
                "cross_bar",
        ...
        rootDef.addOrReplaceChild(
                "cannon",
                CubeListBuilder.create().texOffs(20, 0).addBox(-2F, -3F, -12F, 4F, 4F, 14F),
                PartPose.offset(0F, 16F, 0F));
    ...
    public void setupAnim(DirectedTurretModelState state) {
        ...
        for (ModelPart part : new ModelPart[] { cannon }) {
            part.xRot = rotationX;
            part.yRot = rotationZ;
        }
    }
