...
public class RocketTurretModel extends PartModel implements AnimatedTurretModel {
    ...
    private final ModelPart missile1;
    ...
    public RocketTurretModel(ModelPart root) {
        ...
        this.missile1 = root.getChild("missile1");
        this.missile2 = root.getChild("missile2");
    }
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        rootDef.addOrReplaceChild(
                "launcher",
                CubeListBuilder.create().texOffs(36, 0).addBox(-2F, -5F, -2F, 4F, 8F, 8F),
                PartPose.offset(0F, 15F, 0F));
        rootDef.addOrReplaceChild(
                "missile1",
                CubeListBuilder.create().texOffs(0, 6).addBox(-1F, -5F, -4F, 2F, 2F, 2F),
                PartPose.offset(0F, 16F, 0F));
        rootDef.addOrReplaceChild(
                "missile2",
                CubeListBuilder.create().texOffs(0, 6).addBox(-1F, -1F, -4F, 2F, 2F, 2F),
                PartPose.offset(0F, 16F, 0F));
    ...
    public void setupAnim(DirectedTurretModelState state) {
        ...
        for (ModelPart part : new ModelPart[] { launcher, missile1, missile2 }) {
            part.xRot = rotationX;
            part.yRot = rotationZ;
        }
    }
