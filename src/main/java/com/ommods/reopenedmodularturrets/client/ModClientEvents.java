...
public final class ModClientEvents {
    ...
    public static void registerLayerDefinitions(EntityRenderersEvent.RegisterLayerDefinitions event) {
        ...
        event.registerLayerDefinition(ModModelLayers.DISPOSABLE_ITEM_TURRET, DisposableItemTurretModel::createBodyLayer);
        event.registerLayerDefinition(ModModelLayers.INCENDIARY_TURRET, IncendiaryTurretModel::createBodyLayer);
        event.registerLayerDefinition(ModModelLayers.ROCKET_TURRET, RocketTurretModel::createBodyLayer);
        event.registerLayerDefinition(ModModelLayers.LASER_TURRET, LaserTurretModel::createBodyLayer);
        event.registerLayerDefinition(ModModelLayers.POTATO_CANNON_TURRET, PotatoCannonTurretModel::createBodyLayer);
        event.registerLayerDefinition(ModModelLayers.RAIL_GUN_TURRET, RailGunTurretModel::createBodyLayer);
        event.registerLayerDefinition(ModModelLayers.RELATIVISTIC_TURRET, RelativisticTurretModel::createBodyLayer);
        event.registerLayerDefinition(ModModelLayers.TELEPORTER_TURRET, TeleporterTurretModel::createBodyLayer);
